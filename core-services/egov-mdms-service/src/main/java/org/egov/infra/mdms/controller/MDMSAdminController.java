...
public class MDMSAdminController {
	...
	private ResponseEntity<String> create(String entity, @RequestBody EntityRequest request) {
		adminService.create(entity, request);
		return new ResponseEntity<>("Successfully created!", HttpStatus.CREATED);
	}
	
	@PostMapping("{entity}/_update")
	private void update(String entity, @RequestBody EntityRequest request) {
