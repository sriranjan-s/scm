...
const AppealDashboard = () => {
    ...
    const handleAppealClick = (grievanceId, appealId) => {
        history.push(`/digit-ui/employee/hrms/grievance-details/${grievanceId}/${appealId}`); 
    };
        ...
        <div className="HomePageContainer">
            ...
            >
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div style={{ padding: '0 20px', marginTop: "25px", width: "1100px" }}>
                        <table
                            style={{
                                width: '100%',
