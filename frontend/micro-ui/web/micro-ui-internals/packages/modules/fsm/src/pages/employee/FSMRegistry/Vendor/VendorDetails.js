                ...
                <React.Fragment key={index}>
                  ...
                  <div style={!isMobile ? { marginLeft: "-15px" } : {}}>
                    <StatusTable>
                            ...
                            <div className="card-head">
                              ...
                              <div style={{ display: "flex" }}>
                                <span onClick={() => onEdit(data, detail.type, data.id)}>
                                  <EditIcon style={{ cursor: "pointer", marginRight: "20px" }} className="edit" fill="#23316b" />
                                </span>
                                <span onClick={() => onDelete(data, detail.type, data.id)}>
                                  <DeleteIcon style={{ cursor: "pointer" }} className="delete" fill="#23316b" />
                                </span>
                              </div>
                            </div>
                      ...
                      {detail.type && (
                        <div
                          style={{ color: "#23316b", cursor: "pointer", marginLeft: "16px" }}
