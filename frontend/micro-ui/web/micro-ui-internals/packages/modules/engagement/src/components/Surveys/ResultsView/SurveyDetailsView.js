...
const SurveyDetailsView = ({surveyTitle,surveyDesc,t,surveyId}) => {
  ...
  return (
      <div className="surveydetailsform-wrapper">
        ...
        {/* <button
          type={"button"}
          style={{ border: "2px solid #23316b", backgroundColor: "white", padding: "8px 8px",width:"200px",marginLeft:"50px",marginTop:"-45px" }}
          onClick={() => history.push(`/digit-ui/employee/engagement/surveys/inbox/details/${surveyId}`)}
        >
          <header style={{ color:"#23316b"}}>{t("SURVEY_QUESTIONS")}</header>
        </button> */}
